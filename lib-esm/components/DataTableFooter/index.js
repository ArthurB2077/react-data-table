...
export var DataTableFooter = function (_a) {
    ...
    var hiddenCSVDowloadLinkRef = useRef(null);
    var hiddenJSONDowloadLinkRef1 = useRef(null);
    ...
    return (React.createElement("div", { className: "data-table-footer" },
        React.createElement("div", { className: "data-table-footer-pagination" },
            React.createElement("button", { disabled: currentPage === numberOfPage[0], className: "".concat(currentPage === numberOfPage[0] ? "selected-button" : ""), onClick: function () { return setPage(numberOfPage[0]); } }, firstLabel),
            ...
            React.createElement("select", { onChange: function (event) { return setPage(parseInt(event.target.value)); }, value: currentPage }, numberOfPage.map(function (page, index) {
                return (React.createElement("option", { key: "page-".concat(index), value: page }, page));
            })),
            React.createElement("button", { onClick: function () {
            ...
            React.createElement("button", { disabled: currentPage === numberOfPage[numberOfPage.length - 1], className: "".concat(currentPage === numberOfPage[numberOfPage.length - 1] ? "selected-button" : ""), onClick: function () { return setPage(numberOfPage[numberOfPage.length - 1]); } }, lastLabel)),
        React.createElement("div", { className: "data-table-footer-export" },
            ...
            React.createElement("span", { onClick: function () { return downloadToCSV(headers, rows); } }, renderCsvSVG("")),
            React.createElement("a", { ref: hiddenJSONDowloadLinkRef1, href: ".", style: { display: "none" } }, "Download JSON"),
            React.createElement("span", { onClick: function () { return downloadToJSON(headers, rows); } }, renderJsonSVG("")))));
};
