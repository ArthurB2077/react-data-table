...
export var usePagination = function (data, page, itemPerPage, sortData) {
    var _a = useState([]), numberOfPage = _a[0], setNumberOfPage = _a[1];
    var _b = useState([]), dataBatchPerPage = _b[0], setDataBatchPerPage = _b[1];
    useEffect(function () {
