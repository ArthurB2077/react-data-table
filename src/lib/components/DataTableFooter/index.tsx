...
const DataTableFooter: React.FC<Props> = ({ numberOfPage, setPage, currentPage, headers, rows }): JSX.Element => {
    ...
    const downloadToCSV: Function = (headers: Props["headers"], rows: Props["rows"]): void => {
    ...
    const downloadToJSON: Function = (headers: Props["headers"], rows: Props["rows"]): void => {
