...
const usePagination = (data, page, itemPerPage, sortData) => {
    const [numberOfPage, setNumberOfPage] = (0, react_1.useState)([]);
    const [dataBatchPerPage, setDataBatchPerPage] = (0, react_1.useState)([]);
    (0, react_1.useEffect)(() => {
